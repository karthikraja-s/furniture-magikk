...
class App extends Component {
  ...
  captchaInit = () => {
    if (this.applicationVerifier && this.recaptchaWrapperRef) {
      ...
      this.recaptchaWrapperRef.innerHTML = <div id="recaptcha-container" />;
    }
  ...
  render() {
    return (
      <React.Fragment>
        <div id="login">
          <h3 className="text-center text-white pt-5">Mobile Number</h3>
